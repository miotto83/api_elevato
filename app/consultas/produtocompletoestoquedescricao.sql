SELECT
        ...
        CAST(SUM(ESTOQUESEVEROGRAVATAI) AS VARCHAR(20)) AS ESTOQUESEVEROGRAVATAI
FROM
(SELECT
        ...
        PSV1.QTDDISPONIVEL AS ESTOQUESEVEROGRAVATAI,
...
LEFT JOIN DBA.PRODUTOS_SALDOS_VIEW AS PSV1
 ON PRODUTOS_VIEW.IDPRODUTO=PSV1.IDPRODUTO AND PRODUTOS_VIEW.IDSUBPRODUTO=PSV1.IDSUBPRODUTO AND PSV1.IDEMPRESA in (13,26) AND PSV1.IDLOCALESTOQUE in (6,124) 
